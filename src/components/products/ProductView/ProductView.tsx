...
import { SanitazeHTML } from 'app/components/shared/SanitazeHTML';
  ...
  return (
    <main className={styles.ProductView}>
      <section className={styles.ProductView__images}>
        <Image loading='eager' src={product.image} width={500} height={500} quality={80} alt={product.title} />
      </section>
      <section className={styles.ProductView__info}>
        ...
        <SanitazeHTML tag='p'>{product.description}</SanitazeHTML>
